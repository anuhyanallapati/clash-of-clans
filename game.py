...
from characters import spawnBarbarian, move_barbarians, spawnArcher, move_archers, spawnStealth_Archer, move_stealth_archers, spawnDragon, move_dragons, spawnHealer, move_healers, spawnBalloon, move_balloons, clearTroops
...
while(True):
    ...
    if ch == 'w':
        ...
        spawnStealth_Archer(V.spawn_points[0])
    elif ch == 'g':
        spawnStealth_Archer(V.spawn_points[1])
    elif ch == 'y':
        spawnStealth_Archer(V.spawn_points[2])
    elif ch == 'e':
