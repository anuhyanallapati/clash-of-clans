...
def printMap(V):
    ...
    for stealth_arch in stealth_archers:
        ...
        map_matrix[a][b] = stealth_archColor(stealth_arch) + Fore.BLACK + 'ST'
        map_matrix[a+1][b] = stealth_archColor(stealth_arch) + Fore.BLACK + '  '
        map_matrix[a][b+1] = stealth_archColor(stealth_arch) + Fore.BLACK + 'AR'
    ...
    for he in healers:
        a= 2*he.position[0]
        b = 2*he.position[1]
        map_matrix[a][b] = heColor(he) + Fore.BLACK + 'HE'
        map_matrix[a+1][b] = heColor(he) + Fore.BLACK + 'AL'
        map_matrix[a][b+1] = heColor(he) + Fore.BLACK + 'ER'
        map_matrix[a+1][b+1] = heColor(he) + Fore.BLACK + '  '
